...
It was originally created to store and manage code developed during my internship.  
Since my internship period has now ended, this repository will no longer be maintained or updated.

Feel free to explore the code if you’re interested in my work during that time —  
but please note that it is no longer actively supported.

You can check out my internship reports here:  
- [4-Week Internship Report](https://github.com/shivam-raj12/Internship-Final-Report/blob/master/Reports/4_Week_Report.pdf)  
- [Final Week Internship Report](https://github.com/shivam-raj12/Internship-Final-Report/blob/master/Reports/8_Week_Report.pdf)

Thank you for your understanding and interest! 🙏

# 🧮 Group Theory Codes – Internship Project
...
- **Organised by:**
  ...
  - The National Academy of Sciences India (NASI), Prayagraj, Uttar Pradesh
...
- **Report Writing Tools:**
  - `LaTeX` – Used to write the internship reports.  
  - `Overleaf` – Online platform used to create and compile LaTeX reports.
